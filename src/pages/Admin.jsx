...
// 10.GÜN - Kategori, katalog, kredi kartı ve analiz bölümleri için Admin sayfası oluşturuldu.
function Admin({ onNavigateHome }) {
  ...
  // 10.GÜN - Admin ekranı açıldığında gerekli Redux verilerinin yüklenmesi sağlandı.
  useEffect(() => {
    if (!currentUser?.id) {
      return;
    }
  ...
  return (
    <div className="page-container dashboard-page-container">
      <div className="welcome-card transaction-card">
        {/* 10.GÜN - Admin sayfasına geri dönüş ve çıkış işlemleri eklendi. */}
